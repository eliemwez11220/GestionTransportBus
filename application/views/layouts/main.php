...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | Bus Management Application</title>
        <!-- favicon
        ============================================ -->
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">TRANSBUS</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">TRANSBUS</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if($this->session->fonction == "admin" OR $this->session->fonction == "grm"){ ?>
                        <li>
                            <a href="#">
                                <i class="fa fa-address-book-o"></i> <span>Mouvements Bus</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('bus/index');?>"><i class="fa fa-plus"></i> 
                                        Bus
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="<?php echo site_url('chauffeur/index');?>"><i class="fa fa-plus"></i> 
                                        Chauffeurs
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('mouvement/index');?>"><i class="fa fa-list-ul"></i>
                        ...
                        <?php } if($this->session->fonction == "admin" OR $this->session->fonction == "gr"){ ?>
                        <li>
                            <a href="#">
                                <i class="fa fa-address-book-o"></i> <span>Entretiens Bus</span>
                            </a>
                            <ul class="treeview-menu">
                               
                                <li class="active">
                                    <a href="<?php echo site_url('mecanicien/index');?>"><i class="fa fa-plus"></i> 
                                        Mecaniciens
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('entretien/index');?>"><i class="fa fa-list-ul"></i>
                                        Entretien
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-address-book-o"></i> <span>Rapports</span>
                            </a>
                            <ul class="treeview-menu">
                               
                                <li class="active">
                                    <a href="<?php echo site_url('mouvement/rapport');?>"><i class="fa fa-plus"></i> 
                                        Mouvement bus
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('entretien/rapport');?>"><i class="fa fa-list-ul"></i>
                                        Entretien bus
                                    </a>
                                </li>
                            </ul>
