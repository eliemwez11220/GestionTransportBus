    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Entretien - Nouvel enregistrement</h3>
            </div>
            <?php echo form_open('entretien/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="bus_sid" class="form-control">
								<option value="">selectionner bus</option>
								<?php 
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="mec_sid" class="form-control">
								...
								{
									$selected = ($mecanicien['mec_id'] == $this->input->post('mec_sid')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateEntretien" value="<?php echo $this->input->post('dateEntretien'); ?>" class="has-datepicker form-control" id="dateEntretien" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="etatBus" value="<?php echo $this->input->post('etatBus'); ?>" class="form-control" id="etatBus" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="fraisEntretien" class="control-label">FraisEntretien</label>
						<div class="form-group">
							<input type="text" name="fraisEntretien" value="<?php echo $this->input->post('fraisEntretien'); ?>" class="form-control" id="fraisEntretien" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="panneDetectee" class="control-label">PanneDetectee</label>
						<div class="form-group">
							<textarea name="panneDetectee" class="form-control" id="panneDetectee"><?php echo $this->input->post('panneDetectee'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="pieceEndommagee" class="control-label">PieceEndommagee</label>
						<div class="form-group">
							<textarea name="pieceEndommagee" class="form-control" id="pieceEndommagee"><?php echo $this->input->post('pieceEndommagee'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="ent_observation" class="control-label">Observation</label>
						<div class="form-group">
							<textarea name="ent_observation" class="form-control" id="ent_observation"><?php echo $this->input->post('ent_observation'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
          	<div class="box-footer">
            	<button type="submit" class="btn btn-success">
            		<i class="fa fa-check"></i> Enregistrer entretien
            	</button>
          	</div>
            <?php echo form_close(); ?>
      	</div>
